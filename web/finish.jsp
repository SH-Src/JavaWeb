        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="member-add.jsp" method="post">
                <div class="panel loginbox">
                    <div class="text-center margin-big padding-big-top"><h1>诊断完成</h1></div>
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        <div class="form-group">
                            <div class="field">
                                <label class="form-label col-xs-2 col-sm-2">挂号ID: </label>
                                <input type="text" class="input input-big" name="name" readonly="readonly" value=<%=registerID%>>
                            </div>
                        </div>
                        <!--  <div class="form-group">
                            <div class="field">
